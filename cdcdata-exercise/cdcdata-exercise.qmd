...
This dataset comes from the CDC’s Cumulative Influenza Vaccination Coverage for Adults 18 years and older in the United States during the 2020-21 flu season. 
 ...
 Link: https://data.cdc.gov/Vaccinations/Cumulative-Influenza-Vaccination-Coverage-Adults-1/kmap-fsfn/about_data
...
#Load the data
flu_data <- read_csv("cdcdata-exercise/Cumulative_Influenza_Vaccination_Coverage_20260210.csv")
...
write_csv(flu_trimmed, "cdcdata-exercise/flu_trimmed_dataset.csv")
```
